  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 pointer-events-auto">
      <a
        ...
        className="relative flex items-center justify-center gap-2 px-6 h-14 rounded-full text-white bg-[#25D366] shadow-[0_8px_30px_rgba(37,211,102,0.4)] hover:shadow-[0_8px_35px_rgba(37,211,102,0.6)] hover:scale-105 active:scale-95 transition-all duration-300 group"
      >
        <svg
          viewBox="0 0 16 16"
